 ...
 * User: jbaumann
 * File: GetCategorySingleIdTest.php
 * Date: 18.01.2016
 * Time: 11:57
 */
...
class GetCategorySingleIdTest extends AbstractTestCase
{
    /**
     * @return boolean
     */
    public function test()
    {
        ...
        $errors[] = $this->_apiFacade->getCategoryById(Configuration::TEST_CATEGORY)->getError();
